...
FEATURES = [
    ...
    ('engine/core/checks.js',   'open_end:',        'an open end ring must be buried in another body'),
    ('engine/core/junction.js', 'blendJunctionSkin', 'skin weights blend across the junction band'),
    ('engine/core/compile.js',  'membraneColours',  'membranes take colours in their (u, t) frame'),
    ('engine/core/compile.js',  'resolveHostPart',  'a part can be seated on a part (host_part)'),
    ('cards/SYNTAX.md',         '"host_part"',      'host_part is documented'),
    ...
    ('harness/outline.py',      'COLOUR = baseColorFactor', 'the baked colour is read whole, not COLOR_0 alone'),
    ...
    ('harness/outline.py',      'def colour_measures', 'colour measured off the recorded palette, no browser'),
